...
#define OP_AJIT_BIT_5_AND_6(x)    (((x) & 0x3) << 6)                          /* Set the bits 5 and 6 for AJIT */
/* #define OP_AJIT_BIT_5_AND_6(x)    (((x) & 0x3) << 5)                          /\* Set the bits 5 and 6 for AJIT *\/ */
#define OP_AJIT_BIT_7_THRU_9(x)   (((x) & 0x3) << 9)                          /* Set bits 7 through 9 for AJIT */
...
/* #define F7(a, b, c, d)            (OP_AJIT_BITS_30_TO_31(a) | \ /\* op *\/ */
/* 				   OP_AJIT_BITS_19_TO_24(b) | \ /\* op3 *\/ */
/* 				   OP_AJIT_BITS_13_TO_13(c) | \ /\* i *\/ */
/* 				   OP_AJIT_BITS_05_TO_12(d))	/\* set to zero *\/ */
/* /\* For SIMD Floating point ops *\/ */
/* #define F8(a, b, c)               (OP_AJIT_BITS_30_TO_31(a) | \ /\* op *\/ */
/* 				   OP_AJIT_BITS_19_TO_24(b) | \ /\* op3 *\/ */
/* 				   OP_AJIT_BITS_05_TO_13(c))	/\* opf *\/ */
...
/* /\* For SIMD II instructions *\/ */
/* #define F7(a, b, c, d)            (OP_AJIT_BITS_30_TO_31(a) | \ */
/* 				   OP_AJIT_BITS_19_TO_24(b) | \ */
/* 				   OP_AJIT_BITS_13_TO_13(c) | \ */
/* 				   OP_AJIT_BITS_05_TO_12(d)) */
/* #define F10(a, b, c, d)           (OP_AJIT_BITS_30_TO_31(a) | \ */
/* 				   OP_AJIT_BITS_19_TO_24(b) | \ */
/* 				   OP_AJIT_BITS_13_TO_13(c) | \ */
/* 				   OP_AJIT_BITS_08_TO_12(0)) */
