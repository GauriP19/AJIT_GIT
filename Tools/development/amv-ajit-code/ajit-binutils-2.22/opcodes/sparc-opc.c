...
/* AJIT Additions */
/* CSWAP family */
{ "cswapd",     F3(3, 0x2f, 0x0), F3(~3, ~0x2f, ~0x0), "[1+2]A,d", 0, v8}, /* AJIT */
{ "cswapd",     F3(3, 0x2f, 0x1), F3(~3, ~0x2f, ~0x1), "[1+i],d",  0, v8}, /* AJIT */
{ "cswapda",    F3(3, 0x3f, 0x0), F3(~3, ~0x3f, ~0x0), "[1+2]A,d", 0, v8}, /* AJIT */
{ "cswapda",    F3(3, 0x3f, 0x1), F3(~3, ~0x3f, ~0x1), "[1+i],d",  0, v8}, /* AJIT */
...
{ "slld",	F5(2, 0x25, 0, 0x2), F5(~2, ~0x25, ~0, ~0x2),	        "1,Y,d", 0, v6 }, /* AJIT */
{ "slld",	F5(2, 0x25, 1, 0x2), F5(~2, ~0x25, ~1, ~0x2),	        "1,2,d", 0, v6 }, /* AJIT */
{ "sra",	F3(2, 0x27, 0), F3(~2, ~0x27, ~0)|(1<<12)|(0x7f<<5),	"1,2,d", 0, v6 },
{ "sra",	F3(2, 0x27, 1), F3(~2, ~0x27, ~1)|(1<<12)|(0x7f<<5),	"1,X,d", 0, v6 },
{ "srad",	F5(2, 0x27, 0, 0x2), F5(~2, ~0x27, ~0, ~0x2),	        "1,Y,d", 0, v6 }, /* AJIT */
{ "srad",	F5(2, 0x27, 1, 0x2), F5(~2, ~0x27, ~1, ~0x2),	        "1,2,d", 0, v6 }, /* AJIT */
{ "srl",	F3(2, 0x26, 0), F3(~2, ~0x26, ~0)|(1<<12)|(0x7f<<5),	"1,2,d", 0, v6 },
{ "srl",	F3(2, 0x26, 1), F3(~2, ~0x26, ~1)|(1<<12)|(0x7f<<5),	"1,X,d", 0, v6 },
{ "srld",	F5(2, 0x26, 0, 0x2), F5(~2, ~0x26, ~0, ~0x2),	        "1,Y,d", 0, v6 }, /* AJIT */
{ "srld",	F5(2, 0x26, 1, 0x2), F5(~2, ~0x26, ~1, ~0x2),	        "1,2,d", 0, v6 }, /* AJIT */
...
{ "vsubd8",	F6(2, 0x04, 0, 1, 1), F6(~2, ~0x04, ~0, ~1, ~1),	"1,2,d", 0, v8 }, /* AJIT */
{ "vsubd16",	F6(2, 0x04, 0, 1, 2), F6(~2, ~0x04, ~0, ~1, ~3),	"1,2,d", 0, v8 }, /* AJIT */
{ "vsubd32",	F6(2, 0x04, 0, 1, 4), F6(~2, ~0x04, ~0, ~1, ~4),	"1,2,d", 0, v8 }, /* AJIT */
...
{ "vaddd8",	F6(2, 0x00, 0, 1, 1), F6(~2, ~0x00, ~0, ~1, ~1),	"1,2,d", 0, v8 }, /* AJIT */
{ "vaddd16",	F6(2, 0x00, 0, 1, 2), F6(~2, ~0x00, ~0, ~1, ~3),	"1,2,d", 0, v8 }, /* AJIT */
{ "vaddd32",	F6(2, 0x00, 0, 1, 4), F6(~2, ~0x00, ~0, ~1, ~4),	"1,2,d", 0, v8 }, /* AJIT */
...
/*
 * "smuldaj", "smuldajcc",  "umuldaj" and  "umuldajcc" are  names that
 * use  the string  "aj" and  avoid clashes  with the  "umuld" set  of
 * instructions of a  Sparc variant.  We do not need  to support other
 * Sparc.  Hence, for AJIT, we  delete out those instructions, and use
 * their names without the "aj" string.
 */
/* { "smuldaj",	F4(2, 0x0b, 0, 1), F4(~2, ~0x0b, ~0, ~1),	"1,2,d", F_MUL32, v8 }, /\* AJIT *\/ */
...
/* { "smuldajcc",	F4(2, 0x1b, 0, 1), F4(~2, ~0x1b, ~0, ~1),	"1,2,d", F_MUL32, v8 }, /\* AJIT *\/ */
...
/* { "umuldaj",	F4(2, 0x0a, 0, 1), F4(~2, ~0x0a, ~0, ~1),	"1,2,d", F_MUL32, v8 }, /\* AJIT *\/ */
/* { "umuldajcc",	F4(2, 0x1a, 0, 1), F4(~2, ~0x1a, ~0, ~1),	"1,2,d", F_MUL32, v8 }, /\* AJIT *\/ */

{ "vumuld8",	F6(2, 0x0a, 0, 1, 1), F6(~2, ~0x0a, ~0, ~1, ~1),	"1,2,d", 0, v8 }, /* AJIT */
{ "vumuld16",	F6(2, 0x0a, 0, 1, 2), F6(~2, ~0x0a, ~0, ~1, ~3),	"1,2,d", 0, v8 }, /* AJIT */
{ "vumuld32",	F6(2, 0x0a, 0, 1, 4), F6(~2, ~0x0a, ~0, ~1, ~4),	"1,2,d", 0, v8 }, /* AJIT */
{ "vsmuld8",	F6(2, 0x1a, 0, 1, 1), F6(~2, ~0x1a, ~0, ~1, ~1),	"1,2,d", 0, v8 }, /* AJIT */
{ "vsmuld16",	F6(2, 0x1a, 0, 1, 2), F6(~2, ~0x1a, ~0, ~1, ~3),	"1,2,d", 0, v8 }, /* AJIT */
{ "vsmuld32",	F6(2, 0x1a, 0, 1, 4), F6(~2, ~0x1a, ~0, ~1, ~4),	"1,2,d", 0, v8 }, /* AJIT */
...
{ "addbyter",   F7(2, 0x2d, 0x0, 0x0), F7(~2, ~0x2d, ~0x0, ~0x0), "1,2,d", 0, v8}, /* AJIT */
{ "ordbyter",   F7(2, 0x2e, 0x0, 0x0), F7(~2, ~0x2e, ~0x0, ~0x0), "1,2,d", 0, v8}, /* AJIT */
{ "anddbyter",  F7(2, 0x2f, 0x0, 0x0), F7(~2, ~0x2f, ~0x0, ~0x0), "1,2,d", 0, v8}, /* AJIT */
{ "xordbyter",  F7(2, 0x3e, 0x0, 0x0), F7(~2, ~0x3e, ~0x0, ~0x0), "1,2,d", 0, v8}, /* AJIT */
...
{ "vfadd",      F3F(2, 0x34, 0x142), F3F(~2, ~0x34, ~0x142), "v,B,H", F_FLOAT, v8}, /* rs1, rs2, rd are even numbered! */ /* AJIT */
{ "vfsub",      F3F(2, 0x34, 0x146), F3F(~2, ~0x34, ~0x146), "v,B,H", F_FLOAT, v8}, /* rs1, rs2, rd are even numbered! */ /* AJIT */
{ "vfmul",      F3F(2, 0x34, 0x14a), F3F(~2, ~0x34, ~0x14a), "v,B,H", F_FLOAT, v8}, /* rs1, rs2, rd are even numbered! */ /* AJIT */
{ "vfdiv",      F3F(2, 0x34, 0x14e), F3F(~2, ~0x34, ~0x14e), "v,B,H", F_FLOAT, v8}, /* rs1, rs2, rd are even numbered! */ /* AJIT */
{ "vfsqrt",     F3F(2, 0x34, 0x12a), F3F(~2, ~0x34, ~0x12a), "v,B,H", F_FLOAT, v8}, /* rs1, rs2, rd are even numbered! */ /* AJIT */
...
int   amv_list_sparc_opcodes (void);

int
amv_list_sparc_opcodes (void)
{
  /* FILE *tmp = fopen ("/tmp/sparc-opcodes.lst", "w"); */
  FILE *tmp = fopen ("/dev/null", "w");

  if (tmp != NULL) {
    int i = sparc_num_opcodes;

    fprintf (tmp, "%4s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s\n",
	     "Num", "Name", "Match", "Lose", "Args", "Flags", "Arch", "M&L", "Status");

    for (i = 0; i < sparc_num_opcodes; i++) {
      fprintf (tmp, 
	       "%04d | %-10s | 0x%08lX | 0x%08lX | %-10s | 0x%08X | 0x%08X | 0x%08lX | %-10s\n",
	       i,
	       sparc_opcodes[i].name,
	       sparc_opcodes[i].match,
	       sparc_opcodes[i].lose,
	       sparc_opcodes[i].args,
	       sparc_opcodes[i].flags,
	       sparc_opcodes[i].architecture,
	       (sparc_opcodes[i].match & sparc_opcodes[i].lose),
	       ((sparc_opcodes[i].match & sparc_opcodes[i].lose) == 0x0) ? "Ok" : "NOT Ok"
	       );
    }
